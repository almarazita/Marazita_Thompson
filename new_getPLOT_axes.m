function [axs_,fig_,cap_] = new_getPLOT_axes(num, wid, hts, cols, psh, psw, fs, al, cap)
...
if nargin > 8 && ~isempty(cap)
    ...
    cap_ = annotation('textbox', [0, 0, 0.2, 0.05], 'String', ...
        FigureNumber, 'FitBoxToText', 'on', 'BackgroundColor', 'white',...
        'EdgeColor', 'none');
end
