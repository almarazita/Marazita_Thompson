...
if ~alltrials
    ...
    for i = 1:num_sessions
        total_trials = total_trials + all_pyr_cleaned_data{i}.header.validTrials;
    end
...
for i = 1:num_sessions
    ...
    for j = 1:length(hazards)
        ...
        if method == "bs"
            h_data = cur_session.evoked_max_pupil(cur_hazard == h)' - cur_session.baseline_pupil(cur_hazard == h);
